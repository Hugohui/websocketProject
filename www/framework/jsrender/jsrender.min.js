...
$.views.converters("EtmsDate", function (date) {
    var dateObj = eval('new ' + (date.replace(/\//g, '')));
    return dateObj.format("yyyy-MM-dd hh:mm");
});

$.views.converters("goodsNvw", function (value) {
    if (value == "-1") {
        return "--";
    } else {
        return value;
...
$.views.converters("goodsNvwInput", function (value) {
    if (value == "-1") {
        return "";
    } else {
        return value;
...
$.views.helpers({
    replace: function (val, org, current) {
        var reg = '/' + org + '/g';

        return val.replace(reg, current);
    }
});


$.views.converters("Money", function (value) {
    if (value == "-1") {
        return "--";
    } else {
...
$.views.converters("payFee", function (value) {
    if (value == "-1") {
        return "";
    } else {
        return value;
...
$.views.converters("numFix", function (value) {
    if (value !== '--') {
        return Number(value).toFixed(2);
    } else {
        return value;
